...
class RegulationsController extends Controller
{
    ...
    {
        $publication = $this->postRepository->getPaginatedList($request, 'regulations');
        return view('admin.pages.cms.regulations.index', compact('publication', 'request'));
    }
    ...
    public function store(CreateBannerRequest $request)
    {
        ...
        try {
            ...
            if (isset($data['file'])) {
                $response =  $this->fileUploader->upload($data['file'], "regulations");
            ...
            DB::commit();
            session()->flash('success', 'Regulations has been created successfully.');
    ...
    public function destroy(string $id)
    {
        try {
            ...
            session()->flash('success', 'Regulations been deleted successfully.');
            return redirect()->route('regulations.index');
        } catch (Exception $e) {
            session()->flash('danger', 'Oops! Something went wrong.' . $e);
            return redirect()->back()->withInput();
