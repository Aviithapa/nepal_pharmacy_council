...
@section('content')
    ...
    <div class="reg-modal-container" id="reg-modal" data-visible="true">
        <div class="relative">
            <div class="reg-toggle-btn absolute left-0 flex items-center justify-center" id="reg-toggle">
    ...
    <section>
        <div class="npc__announcement-container--fluid flex">
            ...
            <div class="announcement__marquee-container flex-1 overflow-hidden flex items-center">
                <div class="announcement__marquee inline-block whitespace-nowrap">
                    <p class="announcement__marquee-content cursor-pointer flex gap-4 items-center">
                        @foreach ($news as $new)
        ...
        <div class="npc__container--fluid">
            <div class="npc__hero-wrapper flex flex-col gap-4">
                ...
                <div class="npc__quick-links">
                    <div class="npc__quick-links-wrapper flex flex-col justify-between">
                        <!-- NOc And Good Standing  -->
                        {{-- NOC / Good Standing Letter / Specialization Update --}}

                        <a href="https://noc.nepalpharmacycouncil.org.np/" target="_blank" rel="noopener noreferrer"
                            style="height: 70px;"
                            ...
                            <div class="npc__quick-link-title flex">
                                ...
                                <h2 class="" style="text-align: center;">Apply For Noc
                                </h2>
                            </div>
                            <span class="">
                        ...
                        <a href="https://goodstanding.nepalpharmacycouncil.org.np/" target="_blank" rel="noopener noreferrer"
                            style="height: 70px;"
                            class="npc__quick-link {{ getBlinking('1') ? 'blinking-element' : '' }}  flex items-center justify-between">
                            <div class="npc__quick-link-title flex">
                                <span>
                                ...
                                <h2 class="" style="text-align: center;"> Apply for Good Standing
                                    Letter </h2>
                            </div>
                            <span class="">
                                <i class="fa-solid fa-bars"></i>
                        ...
                        <a href="https://nepalpharmacycouncil.org.np/kyp/public/" target="_blank" rel="noopener noreferrer"
                            style="height: 70px;"
                            class="npc__quick-link {{ getBlinking('1') ? 'blinking-element' : '' }}  flex items-center justify-between">
                            <div class="npc__quick-link-title flex">
                                <span>
                        ...
                        <!-- search professional  -->
                        <a href="https://onlinenameregistration.nepalpharmacycouncil.org.np/old_records/search_professional"
                            target="_blank" rel="noopener noreferrer" style="height: 70px;"
                        ...
                        <!-- admit card  -->
                        <a href="https://specilization.nepalpharmacycouncil.org.np/" rel="noopener noreferrer"
                        ...
                        <a href="https://onlinenameregistration.nepalpharmacycouncil.org.np/admitcards" target="_blank"
                ...
                <div class="npc__news">
                    ...
                    <div class="npc__news-content">
                        <div class="npc__news-content-wrapper">
                            @foreach ($news as $index => $new)
                                <div class="npc__news-item flex gap-2 py-2">
                                    ...
                                    <div class="npc__news-item-right {{ $index === 0 ? 'blinking-text' : '' }}"
                                        @if ($index === 0) style='color:red;' @endif>
                                        <h2>
                        ...
                        <div class="npc__read-more-wrapper">
                            <a href="{{ url('news') }}" class="npc__read-more flex items-center justify-center gap-2">
                                <span>read more</span>
                ...
                <div class="npc__facebook-iframe">
                    <div class="npc__facebook-iframe-container">
                        <iframe
                            ...
                            width="100%" height="400" style="border: none; overflow: hidden" scrolling="no"
        ...
        <div class="npc__container--fluid">
            <div class="npc__about-container flex gap-8">
                ...
                <div class="npc__about-content">
                    ...
                    <a href="/about" class="npc__about-read-more mt-1 flex items-center justify-center gap-2">
                        <span>read more</span>
