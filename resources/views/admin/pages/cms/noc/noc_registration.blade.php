...
<html lang="en">
  ...
  <body>
    <div
      ...
      style="border-bottom: 2px solid #0000ff; margin-bottom: 1rem"
    >
      <div class="logo_img" style="width: 100%; height: 9rem">
        <img
          style="width: 100%; height: 100%; object-fit: cover"
          src="https://placehold.co/800x150"
          alt="npc_logo"
        />
      </div>
    </div>
    <section>
      <div
        ...
        style="width: 90%; max-width: 1440px; margin: 0 auto"
      >
        ...
        <div class="ref_container" style="width: 100%; color: #0000ff; font-weight: 600; margin-bottom: 1rem; font-style: italic;">
          ...
          >
            <div style="font-weight: 600">
              <p><span style="text-transform: capitalize;">{{ $nocData->title }} </span>{{ $nocData->first_name . ' ' .  $nocData->middle_name  . ' ' .   $nocData->last_name}}</p>
              <p>Citizenship No: {{  $nocData->citizenship }}</p>
              <p>{{ $nocData->tole . ' ' . $nocData->ward  . ' ' . $nocData->municipality . ' ' .   $nocData->district }}, Nepal</p>
            </div>
            <div
              class="subject_container"
              style="text-align: center; font-weight: 600; margin-bottom: 1rem"
            >
            ...
            <div class="noc_body" style="font-size: 14px; line-height: 30px;">
              ...
              <div
                ...
                style="padding-left: 200px; margin-bottom: 1rem; line-height: 30px;"
              >
                <ul
                  style="
